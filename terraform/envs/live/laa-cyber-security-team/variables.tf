...
variable "applications" {
  ...
  default = {
    "default_app" = {
      ...
      owners                         = ["ellis.kenyo@justice.gov.uk", "kyle.obrien@justice.gov.uk"]
      application_contacts           = ["ellis.kenyo@justice.gov.uk", "kyle.obrien@justice.gov.uk"]
      allowed_groups                 = []
      homepage_url                   = null
      logout_url                     = null
      redirect_uris                  = null
