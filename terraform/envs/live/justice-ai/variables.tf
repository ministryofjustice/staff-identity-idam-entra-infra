...
locals {
  applications = {
    ...
    "STG-AI-Onboarding-Optimisation-Prod" = {
      ...
      allowed_groups                 = ["STG HMPPS Onboarding Optimisation Prod", "Justice-ai-unit-staff"]
      homepage_url                   = null
      logout_url                     = null
      redirect_uris                  = ["https://onboardingoptimisation-prod-frontend.azurewebsites.net/.auth/login/aad/callback"]
      mobile_desktop_redirect_uris   = []
      access_token_issuance_enabled  = false
      id_token_issuance_enabled      = true
      app_roles                      = []
    ...
    "STG-AI-Onboarding-Optimisation-Dev" = {
      ...
      application_contacts           = ["Sam.Lhuillier@justice.gov.uk", "Harry.Waterman@justice.gov.uk", "Ehsan.Ashouri@justice.gov.uk", "Francis.Webb1@justice.gov.uk", "Luke.Plausin@justice.gov.uk"]
      owners                         = ["Sam.Lhuillier@justice.gov.uk", "Harry.Waterman@justice.gov.uk", "Ehsan.Ashouri@justice.gov.uk", "Francis.Webb1@justice.gov.uk", "Luke.Plausin@justice.gov.uk"]
      allowed_groups                 = ["STG HMPPS Onboarding Optimisation Dev", "Justice-ai-unit-staff"]
      homepage_url                   = null
      logout_url                     = null
      redirect_uris                  = ["https://onboardingoptimisation-dev-frontend.azurewebsites.net/.auth/login/aad/callback"]
      mobile_desktop_redirect_uris   = []
      access_token_issuance_enabled  = false
      id_token_issuance_enabled      = true
      app_roles                      = []
    ...
    "STG-AI-Enhanced-Reception-Checks-Prod" = {
    ...
    "STG-AI-Enhanced-Reception-Checks-Dev" = {
      ...
      application_contacts           = ["Sam.Lhuillier@justice.gov.uk", "Harry.Waterman@justice.gov.uk", "Ehsan.Ashouri@justice.gov.uk", "Francis.Webb1@justice.gov.uk", "Luke.Plausin@justice.gov.uk"]
      owners                         = ["Sam.Lhuillier@justice.gov.uk", "Harry.Waterman@justice.gov.uk", "Ehsan.Ashouri@justice.gov.uk", "Francis.Webb1@justice.gov.uk", "Luke.Plausin@justice.gov.uk"]
      allowed_groups                 = ["STG HMPPS Enhanced Reception Checks Dev", "Justice-ai-unit-staff"]
      homepage_url                   = null
      logout_url                     = null
      redirect_uris                  = ["https://enhancedreceptionchecks-dev-frontend.azurewebsites.net/.auth/login/aad/callback"]
      mobile_desktop_redirect_uris   = []
      access_token_issuance_enabled  = false
      id_token_issuance_enabled      = true
      app_roles                      = []
