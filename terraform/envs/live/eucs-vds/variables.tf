...
variable "applications" {
  ...
  default = {
    ...
    "MoJ-OFFICIAL-DEVL-EUCS-VDS-Housekeeping" = {
      ...
      redirect_uris                  = null
      app_roles                      = []
      graph_application_permissions  = ["Application.Read.All", "User.Read.All", "Group.Read.All", "AuditLog.Read.All", "Device.Read.All"]
      graph_delegated_permissions    = []
      tenants_required               = ["LIVE"]
      federated_identity_credentials = []
      service_principle = {
    ...
    "vds_subscription_automation_03" = {
      ...
      department_name                = "EUCS-CORE-AVD"
      team_name                      = "EUCS-CORE-Infrastructure-AVD"
      application_name               = "MoJ-OFFICIAL-Prod-Spoke-EUCSVD03-TF"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = ["David.Close@JusticeUK.onmicrosoft.com", "Dragan.letic1@JusticeUK.onmicrosoft.com", "Ian.Hegarty@JusticeUK.onmicrosoft.com", "Michael.Kirkpatrick@JusticeUK.onmicrosoft.com", "Paul.Colegate@JusticeUK.onmicrosoft.com"]
      allowed_groups                 = []
    ...
    "vds_subscription_automation_04" = {
      ...
      department_name                = "EUCS-CORE-AVD"
      team_name                      = "EUCS-CORE-Infrastructure-AVD"
      application_name               = "MoJ-OFFICIAL-Prod-Spoke-EUCSVD04-TF"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = ["David.Close@JusticeUK.onmicrosoft.com", "Dragan.letic1@JusticeUK.onmicrosoft.com", "Ian.Hegarty@JusticeUK.onmicrosoft.com", "Michael.Kirkpatrick@JusticeUK.onmicrosoft.com", "Paul.Colegate@JusticeUK.onmicrosoft.com"]
      allowed_groups                 = []
