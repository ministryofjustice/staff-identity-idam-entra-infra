...
variable "applications" {
  ...
  default = {
    ...
    intune_app = {
      notes                        = "Used to manage Intune policies by test Titan"
      service_management_reference = "EUCSVICTOR-1487"
      logo_image                   = "assets/moj-square-icon-215x215.png"
      display_name                 = "app-test-eucs-intunemgt-002"
      department_name              = "EUCS"
      team_name                    = "Application-Platforms"
      application_name             = "Titan"
      create_access_package        = false
    ...
    "auth_app" = {
      notes                        = "Used to handle authentication for Titan Entra ID in test"
      service_management_reference = "EUCSVICTOR-1487"
      logo_image                   = "assets/moj-square-icon-215x215.png"
