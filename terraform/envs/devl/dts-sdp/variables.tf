...
variable "applications" {
  ...
  default = {
    "diso_teams_routing" = {
      notes                          = "DTS Sharepoint Uploader"
      service_management_reference   = "IDAM-3270"
      display_name                   = "DTS-SDP-SharepointUploader"
      department_name                = "DTS"
      team_name                      = "Strategic Data Platform"
      application_name               = "DTS-SDP-SharepointUploader"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = [] # siby.george@justice.gov.uk and denzel.eggerue@justice.gov.uk
      allowed_groups                 = []
      homepage_url                   = null
      logout_url                     = null
      redirect_uris                  = null
