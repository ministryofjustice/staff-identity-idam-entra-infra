...
variable "applications" {
  ...
  default = {
    "eucs-technical-architects" = {
      notes                          = "Used to grant access to Graph API scopes - EUCS Technical Architects"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-EUCS-Technical-Architects-Graph-Permissions"
      department_name                = "EUCS"
      team_name                      = "Technical-Architects"
      application_name               = "MOJO-EUCS-Technical-Architects-Graph-Permissions"
