...
variable "applications" {
  ...
  default = {
    "eucs-techhub" = {
      notes                          = "Used to grant access to Graph API scopes - EUCS TechHub"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-EUCS-TechHub-Graph-Permissions"
      department_name                = "EUCS"
      team_name                      = "TechHub"
      application_name               = "MOJO-EUCS-TechHub-Graph-Permissions"
