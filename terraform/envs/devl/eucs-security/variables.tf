...
variable "applications" {
  ...
  default = {
    "eucs-security" = {
      notes                          = "Used to grant access to Graph API scopes - EUCS Security"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-EUCS-Security-Graph-Permissions"
      department_name                = "EUCS"
      team_name                      = "Security"
      application_name               = "MOJO-EUCS-security-Graph-Permissions"
