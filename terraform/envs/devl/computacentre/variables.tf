...
variable "applications" {
  ...
  default = {
    "computacentre" = {
      notes                          = "Used to grant access to Graph API scopes - ComputaCenter BreakFix Engineer"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-computacentre-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "ComputaCentre"
      application_name               = "MOJO-computacentra-Graph-Permissions"
