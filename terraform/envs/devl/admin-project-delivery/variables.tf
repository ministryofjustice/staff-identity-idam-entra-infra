...
variable "applications" {
  ...
  default = {
    "admin-project-delivery" = {
      notes                          = "Used to grant access to Graph API scopes - admin-project-delivery"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-admin-project-delivery-Graph-Permissions"
      department_name                = "Justics-Digital"
      team_name                      = "admin-project-delivery"
      application_name               = "MOJO-admin-project-delivery-Graph-Permissions"
