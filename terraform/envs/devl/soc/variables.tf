...
variable "applications" {
  ...
  default = {
    "soc_l1" = {
      ...
      display_name                   = "MOJO-SOC-L1-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "SOC"
      application_name               = "MOJO-SOC-L1-Graph-Permissions"
    ...
    "soc_l2" = {
      notes                          = "Used to grant access to Graph API scopes"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-SOC-L2-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "SOC"
      application_name               = "MOJO-SOC-L2-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
    ...
    "soc_l3" = {
      notes                          = "Used to grant access to Graph API scopes"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-SOC-L3-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "SOC"
      application_name               = "MOJO-SOC-L3-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
