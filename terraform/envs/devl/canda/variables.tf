...
variable "applications" {
  ...
  default = {
    "canda_l2" = {
      notes                          = "Used to grant access to Graph API scopes - Converge And Accelerate Evolve Project Team L2"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-canda-l2-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Converge-And-Accelerate-Evolve-Project-Team"
      application_name               = "MOJO-canda-l2-Graph-Permissions"
    ...
    "canda_l3" = {
      notes                          = "Used to grant access to Graph API scopes - Converge And Accelerate Evolve Project Team L3"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-canda-l3-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Converge-And-Accelerate-Evolve-Project-Team"
      application_name               = "MOJO-canda-l3-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
    ...
    "canda_Architect" = {
      notes                          = "Used to grant access to Graph API scopes - Converge And Accelerate Evolve Project Team Architect"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-canda-Architect-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Converge-And-Accelerate-Evolve-Project-Team"
      application_name               = "MOJO-canda-Architect-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
