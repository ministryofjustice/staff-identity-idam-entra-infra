...
variable "applications" {
  ...
  default = {
    "Mobile-2LS-L3" = {
      notes                          = "Used to grant access to Graph API scopes - Technology Operations Mobile Team Level 3 Engineer"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-Mobile-2LS-L3-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Mobile"
      application_name               = "MOJO-Mobile-2LS-L3-Graph-Permissions"
    ...
    "Mobile-2LS-L2" = {
      notes                          = "Used to grant access to Graph API scopes - Technology Operations Mobile Team Level 2 Engineer"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-Mobile-2LS-L2-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Mobile"
      application_name               = "MOJO-Mobile-2LS-L2-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
    ...
    "Mobile-2LS-L1" = {
      notes                          = "Used to grant access to Graph API scopes - Technology Operations Mobile Team Level 1 Engineer"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-Mobile-2LS-L1-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "Mobile"
      application_name               = "MOJO-Mobile-2LS-L1-Graph-Permissions"
      create_access_package          = false
      access_package_reviewers       = []
      owners                         = []      
      allowed_groups                 = []
