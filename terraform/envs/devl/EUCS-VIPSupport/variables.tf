...
variable "applications" {
  ...
  default = {
    "EUCS-VIPSupport" = {
      notes                          = "Used to grant access to Graph API scopes - EUCS-VIPSupport"
      service_management_reference   = "IDAM-1811"
      display_name                   = "MOJO-EUCS-VIPSupport-Graph-Permissions"
      department_name                = "Justice-Digital"
      team_name                      = "EUCS-VIPSupport"
      application_name               = "MOJO-EUCS-VIPSupport-Graph-Permissions"
