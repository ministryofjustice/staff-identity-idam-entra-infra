...
locals {
  applications = {
    "cala-clah-prodexternal" = {
      ...
      logout_url                     = null
      redirect_uris                  = ["https://cases.civillegaladvice.service.gov.uk/auth/entra-callback", "http://localhost:8000/auth/entra-callback"]
      ...
      identifier_uris = ["api://cala-clah-prodexternal"]
      api = {
    ...
    "cala-cla-backend-prodexternal" = {
      ...
      identifier_uris = ["api://cala-cla-backend-prodexternal"]
      api = {
        known_client_applications      = null,
        mapped_claims_enabled          = true,
        requested_access_token_version = 2,
