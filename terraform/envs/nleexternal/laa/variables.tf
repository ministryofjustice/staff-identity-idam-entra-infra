...
variable "applications" {
  ...
  default = {
    ...
    "pui" = {
      ...
      logout_url                   = null
      redirect_uris                = ["https://ccms-pui.laa-test.modernisation-platform.service.justice.gov.uk/civil/login/saml2/sso","https://test-provider-ui-laa-ccms-test.apps.live.cloud-platform.service.justice.gov.uk/civil/login/saml2/sso"]
      mobile_desktop_redirect_uris = null
      app_roles = [
        {
