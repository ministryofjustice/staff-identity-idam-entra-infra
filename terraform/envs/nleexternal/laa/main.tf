...
locals {
  applications = {
    ...
    "get_legal_aid_data" = {
      ...
      homepage_url   = "https://uat-laa-get-payments-finance-data.cloud-platform.service.justice.gov.uk/"
      logout_url     = null
      redirect_uris = [
        "https://uat-laa-get-payments-finance-data.cloud-platform.service.justice.gov.uk/login/oauth2/code/azure"
      ]
      mobile_desktop_redirect_uris   = null
      app_roles                      = []
      graph_application_permissions  = []
